...
unsigned int jo_write_jpg(void *dest, const void *data, int width, int height, int comp, int quality) {
	...
	/*
	 * if you want to use other array data or structure,
	 * this is the place where you have to calculate the
	 * RGB components
	 */
...
/*
 * Funtion to execute the code
 */

void TakePicture(){

	/*
	 * sample vector witch contains RGB data
	 */
	char *image = new char[30*30*3]; // 4 component. RGBX format, where X is unused
